...
<?php
$main = new Main();
$interview = $main->init('News', '', '');
$interview->single_news(-1);
/*
Template Name: Детальная страница новости
*/
?>
<? get_header(); ?>
			...
			<div class="col-12">
				<div class="title-block">
					<div class="plane-title">
						<h1><?= $interview->getData('single_news')->post_title; ?></h1>
					</div>
					<div class="news-detail__content">
						...
						<div class="news-detail__image">
							<a class="fb-img" href="<?= $interview->getData('single_news')->large; ?>">
								<img src="<?= $interview->getData('single_news')->large; ?>" alt=""/>
							</a>
						</div>
						<div class="news-detail__text">
							<p><?= nl2br($interview->getData('single_news')->post_content); ?></p>
						</div>
