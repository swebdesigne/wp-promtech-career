						...
						<div class="accordion" id="faqAccordion">
							...
							<div class="faq-card">
								<div class="faq-title" id="heading<?= $key; ?>">
									...
									<?php if($key != 0) {?>collapsed<?}?>"
									type="button" 
									data-bs-toggle="collapse" 
									data-bs-target="#collapse<?= $key; ?>" 
									aria-expanded="<?php if($key == 0) {?>true<?} else {?>false<?}?>"
									aria-controls="collapse<?= $key; ?>">
									<?= $arg->post_title; ?>
									</button>
								</div>
								<div id="collapse<?= $key; ?>" class="accordion-collapse  collapse <?php if($key == 0) {?>show<?}?>" aria-labelledby="heading<?= $key; ?>" data-bs-parent="#faqAccordion">
									<div class="faq-body">
										<p><?= nl2br($arg->answ); ?></p>
									</div>
								</div>
